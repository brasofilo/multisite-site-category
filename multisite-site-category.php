...
class BL_Multisite_Categories
{
	...
	public function plugin_setup()
	{
        ...
        add_action( 
        	'admin_print_scripts-site-new.php', 
        	array( $this, 'admin_scripts' ) 
    	);
        add_action( 
        	'admin_footer-sites.php', 
        	array( $this,'add_style' ) 
    	);
        add_action( 
        ...
        add_action( 
        	'signup_blogform', 
        	array( $this, 'add_extra_field_on_blog_signup' ) 
    	);
        add_action( 
        	'wpmu_new_blog', 
        	array( $this, 'add_new_blog_field' ) 
    	);
        add_filter( 
        	'add_signup_meta', 
        	array( $this, 'append_extra_field_as_meta' ) 
    	);
        add_filter( 
        	'wpmu_blogs_columns', 
        	array( $this, 'print_columns' ) 
    	);
	}
...
if( function_exists( 'add_action' ) )
{
    ...
    register_activation_hook( 
    	__FILE__, 
    	array ( 'BL_Multisite_Categories', 'on_activation' ) 
	);


    add_action(
		'plugins_loaded',
		array ( BL_Multisite_Categories::get_instance(), 'plugin_setup' )
	);
}
